...
const BLURBS: Partial<Record<BodyId, string>> = {
  ...
  eaglenebula: "Home of the Pillars of Creation — towering columns of gas and dust where new stars are born. About 7,000 light-years away in Serpens.",
  kepler186: "An M-dwarf 560 light-years away hosting five known planets. Discovered by NASA's Kepler mission.",
  kepler186f: "First Earth-size exoplanet found in a habitable zone. Receives about one-third Earth's sunlight — cooler, but potentially clement.",
